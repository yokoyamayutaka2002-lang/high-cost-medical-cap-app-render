...
# 4 months each capped to 30000 -> base_annual = 120000 (>100000)
monthly = {
    '2026-01': {'events':[{'actual_payment': 80000}]},
    '2026-02': {'events':[{'actual_payment': 70000}]},
    '2026-03': {'events':[{'actual_payment': 50000}]},
    '2026-04': {'events':[{'actual_payment': 90000}]},
}
